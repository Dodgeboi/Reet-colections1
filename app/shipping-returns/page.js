  ...
  return (
    <LegalPage eyebrow="Help" title="Shipping & Returns" updated="July 2026">
      <LegalSection title="Shipping">
        ...
        <p>Once your order is confirmed, we pack it within 1–3 business days and email you when it's on the way. Every piece is checked and folded by hand before it ships.</p>
      </LegalSection>
      <LegalSection title="Returns & exchanges">
        ...
        <p>Items should be unworn and unwashed with tags attached. Clearance pieces are final sale and marked as such on the product page.</p>
      </LegalSection>
      ...
      <LegalSection title="Questions">
        <p>Message us on <a href="https://m.me/Reetcollections068" target="_blank" rel="noopener noreferrer" className="text-rose underline hover:text-rose-deep">Facebook</a> or through the <Link href="/contact" className="text-rose underline hover:text-rose-deep">contact page</Link> — we're happy to help.</p>
      </LegalSection>
    </LegalPage>
  );
}
