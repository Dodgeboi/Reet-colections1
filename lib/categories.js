...
export const categories = [
  ...
  { name: "Suit Sets", slug: "suits", subs: [
    { label: "Embroidered Suits", slug: "suits" },
    { label: "Ombre Suits", slug: "suits" },
    { label: "Three-Piece Sets", slug: "suits" },
  ] },
  { name: "Anarkalis", slug: "anarkalis", subs: [
    { label: "Floral Anarkalis", slug: "anarkalis" },
    { label: "Festive Anarkalis", slug: "anarkalis" },
  ] },
